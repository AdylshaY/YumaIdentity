        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedCallbackUrls = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Kullanıcının e-posta adresini doğrulaması için gönderilen token.", "EMAIL_VERIFY" },
                    { 2, "Kullanıcının şifresini sıfırlaması için gönderilen token.", "PASSWORD_RESET" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppRoles_ApplicationId_RoleName",
                table: "AppRoles",
                columns: new[] { "ApplicationId", "RoleName" },
                unique: true);
